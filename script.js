...
document.body.style.backgroundImage = "url('https://source.unsplash.com/random/?" + name + ", landscape')"
...
const myButton = document.querySelector('.unit-button');
 ...
 myButton.addEventListener("click", function(){
  if (isF) {
    ...
    document.querySelector(".temperature").innerText = ((temp * 9/5) + 32).toFixed(1) + "°F";
    document.querySelector(".wind").innerText = "Wind speed: " + (speed/1.609).toFixed(1) + "mph";
    isF = false;
  } else {
...
//     myButton.classList.remove('F');
//     myButton.classList.add('C');
//     weather.displayWeatherF();
//     isF = false;
//   } else {
//     myButton.innerText = '°C';
//     myButton.classList.remove('C');
//     myButton.classList.add('F');
//     weather.displayWeatherC;
//     isF = true;
//   }
// });
